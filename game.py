...
def game():
    ...
    if request.method == 'POST' and started:
        ...
        return render_template('game.html', num1=num1, num2=num2, operation=operation, score=score, duration=duration, start_time=start_time)
        ...
        num1, num2 = generate_new_numbers(operation)
        return render_template('game.html', num1=num1, num2=num2,  operation=operation, score=0, duration=duration, start_time=start_time)
